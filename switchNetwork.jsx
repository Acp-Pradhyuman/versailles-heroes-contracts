...
import { setHomeSearch, setHomeSearchKeyword } from "../../redux/Slice/HomeSearch";
...
function Header({ transparent }) {
	...
	if (chainId == null) {
		...
		// window.alert("please connect your metamask polygon mainnet or chainId 137")
		window.alert("please connect your metamask wallet polygon testnet or chainId 80001");
	...
	// 	// window.alert("please connect your metamask polygon mainnet or chainId 137")
	// 	window.alert("please connect your metamask wallet polygon mainnet or chainId 137");
	// 	window.ethereum.request({
	// 		method: "wallet_addEthereumChain",
	// 		params: [{
	// 			//chainId: "0x13881",
	...
	return (
		<>
			<div class={transparent ? "home-page-nav" : "header-main-wrapper"}>
				<nav
					class={`navbar navbar-expand-lg header-menu-wrap navbar-light bg-transparent ${transparent ? " " : "internal-head"
						}`}
				>
                      ...
                      <>
                        {Object.keys(searchInfo).length !== 0 && (
                          <>
                            ...
                            searchInfo.dataCreator.length > 0 ||
                            searchInfo.dataNft.length > 0 ? (
                              <Link to={`/search/${searchData}`} style={{color: "black"}}>
                                <li>
                                  <a>Press Enter to search all items</a>
                                </li>
                              </Link>
                            ) : (
                              <li>
